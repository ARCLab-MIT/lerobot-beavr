...
def check_timestamps_sync(
    ...
    # Find where episode_index changes (these are episode boundaries)
    episode_changes = np.diff(episode_indices) != 0
    mask = ~episode_changes  # Mask out (set to False) where episodes change
