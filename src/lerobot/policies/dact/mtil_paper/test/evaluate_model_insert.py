...
from lerobot.policies.dact.mtil_paper.test.inference_M import MyInferenceModel
import numpy as np
import matplotlib.pyplot as plt
import torch
from einops import rearrange
from lerobot.policies.dact.mtil_paper.test.sim_env import make_sim_env, BOX_POSE
from lerobot.policies.dact.mtil_paper.test.visualize_episodes import save_videos
from lerobot.policies.dact.mtil_paper.train.mamba_policy import MambaPolicy, MambaConfig
from lerobot.policies.dact.mtil_paper.train.scaler_M import Scaler
from lerobot.policies.dact.mtil_paper.train.M_dataset import MambaSequenceDataset
...
scaler_path = '/home/aposadasn/lerobot-beavr/outputs/datasets/aloha_sim_insertion_processed/scaler_params.pth'  # your own path
checkpoint = 'lightning_logs/version_1/checkpoints/last.ckpt'  # your own path
results_dir = 'outputs/mtil_paper/sim_insertion'  # your own path
#  初始化推理模型
config = MambaConfig()
...
num_queries = 16  # 预测步长
num_rollouts = 500  # 评估的回合数 (reduced for testing)
save_videos_flag = False  # Set to False to speed up evaluation by skipping video saving
